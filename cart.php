...
@media screen and (max-width: 768px) {
    ...
    table[width="40%"] th, table[width="40%"] td {
        display: inline-block; /* Allow inline arrangement */
    ...
    <div class="content">
        <div class="cartoption">		
            ...
            <div class="shopping">
                <div class="shopleft">
                    <a href="index.php"> 
                        <img src="images/shop.png" alt="Continue Shopping" />
                    </a>
                </div>
                <div class="shopright">
                    <a href="payment.php"> 
